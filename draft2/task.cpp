...
//         // ищем ближайший '\n'
//         for (start = cursorPosition; start >= 1; start--) {
//             if (editor.GetText()[start - 1] == '\n') {
//                 break;
//             }
//         }
//         if (start == 0) {
//             // start и есть начало 1 строки
//             return;
//         }
//         // имеем картину вида
//         //  '\n' | start

//         // сколько символов с начала строки
//         size_t diff = cursorPosition - start;
//         size_t snd_slash_n = start - 1;
//         for (snd_slash_n = start - 1; snd_slash_n >= 1; --snd_slash_n) {
//             if (editor.GetText()[snd_slash_n - 1] == '\n') {
//                 break;
//             }
//         }
//         // start -- second_slash_n
//         //   0    12   3  456789   1
//         // '\n' | al '\n' ajdskl | jdls
//         size_t result = snd_slash_n;
//         if (start - snd_slash_n - 1 >= diff) {
//             result += diff;
//         } else {
//             result = snd_slash_n - 1;
//         }
...
// //         size_t diff = cursorPosition - start;
// //         size_t snd_slash_n = start + 1;
// //         for (snd_slash_n = start + 1; snd_slash_n < editor.GetText().length(); ++snd_slash_n) {
// //             if (editor.GetText()[snd_slash_n - 1] == '\n') {
// //                 break;
// //             }
// //         }
// //         if (snd_slash_n == editor.GetText().length()) {
// //             // конец
// //             return;
// //         }
// //         size_t trd_slash_n = snd_slash_n + 1;
// //         for (trd_slash_n = snd_slash_n + 1; trd_slash_n < editor.GetText().length(); ++trd_slash_n) {
// //             if (editor.GetText()[trd_slash_n - 1] == '\n') {
// //                 break;
// //             }
// //         }
// //         // 
...
// //         // diff = 2
// //         // trd_slash_n = 8
// //         // size_t third_slash_n = 

// //         // start -- snd -- trd
// //         size_t result = snd_slash_n;
// //         if (trd_slash_n - snd_slash_n - 1 >= diff) {
// //             result = snd_slash_n + diff;
// //         }  else {
// //             result = trd_slash_n - 1;
// //         }
// //         cursorPosition = result;
// //     }
// //     void AcceptVisitor(CommandVisitor& visitor) override {
...
// //         }
// //         // ищем '\n' с права
// //         size_t slash_n_right = buffer.substr(cursorPosition).find('\n');
// //         size_t slash_n_left = buffer.substr(0, cursorPosition).rfind('\n');
// //         if (slash_n_right == std::string::npos) {
// //             cursorPosition = editor.GetText().size();
// //         } else {
// //             size_t dif = 
// //         }
// //     }
...
//         // Если следующего символа новой строки нет, то курсор остаётся в конце
//         if (slash_n_right == std::string::npos) {
...
// //     void Apply(std::string& buffer, size_t& cursorPosition, std::string& clipboard, TextEditor& editor) override {
// //         std::cout << "-----SELECTION-----\n";
// //         std::cout << "curs pos = " << cursorPosition << "\n";
// //         if (editor.HasSelection()) {
// //             editor.UnselectText();
// //         }
// //         std::cout << "curs pos = " << cursorPosition << "\n";
...
//         // std::cout << "cursor postion = " << editor.GetCursorPosition() << "\n";
//         // std::cout << "text = {" << editor.GetText() << "}\n";
//         std::cout << "DELELELELLTE\n";
//         if (editor.HasSelection()) {
//             std::cout << "erase {" << buffer.substr(editor.GetSelection().first, editor.GetSelection().second - editor.GetSelection().first) << "}\n";
...
//             editor.UnselectText();
//         }
//         std::cout << "substr = " << buffer.substr(cursorPosition - 1, 5) << "\n";
...
// public:
//     void Apply(std::string& buffer, size_t& cursorPosition, std::string& clipboard, TextEditor& editor) override {
//         // будем удалять текст до начала строки, т.е. налево
//         if (editor.HasSelection()) {
//             editor.UnselectText();
//         }
